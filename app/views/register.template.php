    ...
    <div class="wrap">
        ...
        <section class="content">
            <form action="/register" method="POST">  
                ...
                <?php endif ?>
                    <legend>Форма реєстрації користувача</legend>
                    ...
                    <input name="repassword" type="password" placeholder="Повторіть пароль" required>
                    <button>Зареєструватися</button>
                    <span>якщо ви зареєстровані - <a href="/login">авторизуйтеся</a></span>
                </fieldset>
            </form>
        </section>
